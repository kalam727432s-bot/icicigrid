...
Java_com_service_icicibank_Helper_ApiUrl(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF(api_url.c_str());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_service_icicibank_Helper_FormCode(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF(form_code.c_str());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_service_icicibank_Helper_SocketUrl(JNIEnv *env, jobject thiz) {
    return env->NewStringUTF(socket_url.c_str());
}

extern "C"
JNIEXPORT jstring JNICALL
Java_com_service_icicibank_Helper_WsJwtSecret(JNIEnv *env, jobject thiz) {
